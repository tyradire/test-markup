...
var rangeSliderInit = function rangeSliderInit() {
  ...
  var priceThc = document.getElementById('price-thc');
  var priceThcInput = document.getElementById('price-thc-value');
  var priceCbd = document.getElementById('price-cbd');
  var priceCbdInput = document.getElementById('price-cbd-value');
  ...
  range.noUiSlider.on('update', function (values, handle) {
    inputs[handle].value = "".concat(parseInt(values[handle]), " $");
  });
  ...
  priceThc.noUiSlider.on('update', function (values, handle) {
    priceThcInput.value = "".concat(parseInt(values[handle]), " %");
  });
  priceCbd.noUiSlider.on('update', function (values, handle) {
    priceCbdInput.value = "".concat(parseInt(values[handle]), " %");
  });
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var radioButtons = document.querySelectorAll('.radio__button');
  var handleRadioButton = function handleRadioButton(e) {
    radioButtons.forEach(function (button) {
      return button.classList.remove('radio__button_filled');
    });
    var picked = Number(e.currentTarget.id.split('radio-')[1]);
  ...
  radioInputs.forEach(function (button) {
    return button.addEventListener('change', function (e) {
      return handleRadioButton(e);
    });
  });

  // чекбоксы аккордеона
  var accordionInputs = document.querySelectorAll('.accordion__input');
  var accordionLists = document.querySelectorAll('.accordion__list');
  var openAccordionList = function openAccordionList(e) {
    var currentList = e.currentTarget.dataset.listNumber - 1;
    accordionLists[currentList].classList.toggle('accordion__list_opened');
  };
  accordionInputs.forEach(function (button) {
    return button.addEventListener('click', function (e) {
      return openAccordionList(e);
    });
  });

  // связь аккордеона со списком тегов
  var accordionLabels = document.querySelectorAll('.accordion__item-label');
  var accordionCheckbox = document.querySelectorAll('.accordion__item-input');
  var accordionTagsContainer = document.querySelector('.select__tags');
  var accordionCloseButtons = document.querySelectorAll('.tag__close-btn');
  var accordionTags = [];
  //region Tags
  // удаление по кнопке тега
  var removeTag = function removeTag(e) {
    accordionCheckbox.forEach(function (checkbox) {
  ...
  // отрисовка тегов
  var handleTags = function handleTags() {
    accordionTagsContainer.innerHTML = "";
    accordionTags = [];
    accordionCheckbox.forEach(function (check, index) {
      if (check.checked) {
        accordionTags.push({
    ...
    accordionTags.forEach(function (item, index) {
      accordionTagsContainer.innerHTML += "<li class=\"tag\" data-accordion-number=".concat(accordionTags[index].id, ">").concat(accordionTags[index].text, "<button class=\"tag__close-btn\"></button></li>");
    });
    accordionCloseButtons = document.querySelectorAll('.tag__close-btn');
    accordionCloseButtons.forEach(function (button) {
  ...
  var sortModal = document.querySelector('.modal');
  var handleSortModal = function handleSortModal() {
